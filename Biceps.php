...
$currentPage = "biceps"; // Updated the category to "Biceps"
...
<head>
    ...
    <title>Biceps Training Videos - DigitalGym</title>
</head>
            ...
            <?php foreach ($videoUrls as $video) { ?>
                <div>
                    ...
                    <?php if ($isManagerOrTrainer) { ?>
                        ...
                        <form action="Biceps.php" method="post">

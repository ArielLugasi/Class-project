...
$currentPage = "chest"; // Updated the category to "Shoulders"
...
<head>
    ...
    <title>Chest Training Videos - DigitalGym</title>
</head>
            ...
            <?php foreach ($videoUrls as $video) { ?>
                <div>
                    ...
                    <?php if ($isManagerOrTrainer) { ?>
                        ...
                        <form action="Chest.php" method="post">

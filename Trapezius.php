...
$currentPage = "trapezius"; // Updated the category to "Trapezius"
...
<head>
    ...
    <title>Trapezius Training Videos - DigitalGym</title>
</head>
...
<body>
    ...
    <main>
        <section>
            <h2>Trapezius Training Videos</h2>
            <?php foreach ($videoUrls as $video) { ?>
                <div>
                    ...
                    <?php if ($isManagerOrTrainer) { ?>
                        ...
                        <form action="Trapezius.php" method="post">

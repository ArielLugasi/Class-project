...
$currentPage = "hamstrings"; // Updated the category to "Shoulders"
...
<head>
    ...
    <title>Hamstrings Training Videos - DigitalGym</title>
</head>
...
<body>
    ...
    <main>
        <section>
            <h2>Hamstrings Training Videos</h2>
            <?php foreach ($videoUrls as $video) { ?>
                <div>
                    ...
                    <?php if ($isManagerOrTrainer) { ?>
                        ...
                        <form action="Hamstrings.php" method="post">

...
$currentPage = "triceps"; // Updated the category to "Triceps"
...
<head>
    ...
    <title>Triceps Training Videos - DigitalGym</title>
</head>
            ...
            <?php foreach ($videoUrls as $video) { ?>
                <div>
                    ...
                    <?php if ($isManagerOrTrainer) { ?>
                        ...
                        <form action="Triceps.php" method="post">

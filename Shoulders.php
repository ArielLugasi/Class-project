...
$currentPage = "shoulders"; // Updated the category to "Shoulders"
...
<head>
    ...
    <title>Shoulders Training Videos - DigitalGym</title>
</head>
...
<body>
    ...
    <main>
        <section>
            <h2>Shoulders Training Videos</h2>
            <?php foreach ($videoUrls as $video) { ?>
                <div>
                    ...
                    <?php if ($isManagerOrTrainer) { ?>
                        ...
                        <form action="Shoulders.php" method="post">

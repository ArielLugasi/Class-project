...
$currentPage = "forearms"; // Updated the category to "Forearms"
...
<head>
    ...
    <title>Forearms Training Videos - DigitalGym</title>
</head>
...
<body>
    ...
    <main>
        <section>
            <h2>Forearms Training Videos</h2>
            <?php foreach ($videoUrls as $video) { ?>
                <div>
                    ...
                    <?php if ($isManagerOrTrainer) { ?>
                        ...
                        <form action="Forearms.php" method="post">
